  ...
  <header className="bg-white shadow-md">
        <nav className="container mx-auto flex justify-between items-center p-4">
          ...
          <div className="hidden md:flex space-x-4">
            <button className="text-gray-600 hover:text-blue-600"><Link to="/login">Login</Link></button>
            <button className="text-gray-600 hover:text-blue-600 "><Link to="/accountsignup">Sign Up</Link></button>
